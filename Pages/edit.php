...
foreach($files as $file){
		...
		if ($fgbscheck == "fgbs")
  		{
  		echo '<div style="top:46px;left:143px;width:100%;height:100%;position:fixed;z-index:500;background-color:white;padding-top:10px;padding-left:25px;">
<span style="font-family:arial;font-size:20px;color:#333;font-style:italic;">Woah there!</span><br><br>
s:fgbs (aka. file generated by super:.) files are currently a beta filetype used interanally by super:. and currently not supported with this version of super:Pages. =(</div>';
 		 }
		else
 		 {
  		echo "";
