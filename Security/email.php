...
<body>
	...
	<form method="post" action="">
		<p style="font-family:arial;font-size:14px;">Email: <input type="text" name="new_email" value="<?php $files = glob('Security/users/'.$_GET['username'].'.xml');foreach($files as $file){$getemail = new SimpleXMLElement($file, 0, true);echo $getemail->email;};?>" /></p>
